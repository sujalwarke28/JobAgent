    ...
    <div className="animate-in fade-in duration-500 max-w-7xl mx-auto py-8 px-4">
      {needsSetup && (
        <div className="bg-gradient-to-r from-blue-900/40 to-purple-900/40 border border-blue-500/30 p-8 rounded-3xl mb-10 shadow-[0_0_30px_rgba(59,130,246,0.15)] relative text-center">
          <h2 className="text-2xl font-black mb-3 text-white">Unlock AI-Driven Opportunities</h2>
        ...
        <>
          <div className="flex items-center justify-between mb-8">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-2xl font-bold text-white tracking-tight">Top AI Recommendations</h2>
            </div>
            <div className="text-sm font-medium text-gray-500 bg-gray-900 px-3 py-1.5 rounded-lg border border-gray-800">
          ...
          {jobs.length === 0 ? (
            <div className="bg-gray-900 border border-gray-800 rounded-3xl p-16 text-center shadow-xl">
              ...
              <h3 className="text-xl font-bold text-white mb-2">No strong matches yet</h3>
              <p className="text-gray-400 max-w-md mx-auto">We couldn't find roles that perfectly align with your exact skill stack right now. Try updating your profile or check back later as new roles are posted continuously.</p>
            </div>
          ) : (
